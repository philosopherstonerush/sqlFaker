...
class gen_data(Faker):
    def get_provider_for_data_type(self,data_type,charsize,samplesize,refcolumn=None):
        ...
        data_type_mapping = {
            "BIGINT": lambda: self.pyint(0, 9223372036854775808),
            "BINARY": lambda: self.pyint(0, 1),
            "BIT": lambda: self.pyint(0, 1),
            "BLOB": lambda: self.binary(),
            "BOOLEAN": lambda: self.pybool(),
            "CHAR": lambda: self.name(),
            "DATE": lambda: self.date_between(1753 - 1 - 1, 9999 - 12 - 31),
            "DATETIME": lambda: self.date_time_between(1753 - 1 - 1, 9999 - 12 - 31),
            "DECIMAL": lambda: self.pyfloat(min_value=0, max_value=214748.3647),
            "DOUBLE": lambda: self.pyfloat(min_value=0, max_value=214748.3647),
            "ENUM": lambda: self.enum(MySQLDataType),
            "FLOAT": lambda: self.pyfloat(min_value=0, max_value=214748.3647),
            "INTEGER": lambda: self.pyint(0, 2147483647),
            "INT": lambda: self.pyint(0, 2147483647),
            "JSON": lambda: self.json(),
            "LONGBLOB": lambda: self.binary(),
            "LONGTEXT": lambda: self.sentence(),
            "MEDIUMBLOB": lambda: self.binary(),
            "MEDIUMINT": lambda: self.pyint(0, 8388607),
            "MEDIUMTEXT": lambda: self.text(16777215),
            "NCHAR": lambda: self.name(),
            "NVARCHAR": lambda: self.word(),
            "NUMERIC": lambda: self.pyint(),
            ...
            "BINARY_DOUBLE": lambda: self.pyfloat(min_value=-9.999999999999999999999999,max_value=9.9999999999999999999999),
